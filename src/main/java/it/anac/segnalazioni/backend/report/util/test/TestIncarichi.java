...
public class TestIncarichi {
	...
	private static String templateFilename = "template_incarichi.odt";
	...
	public static void main(String[] args) throws Exception {
		...
		SegnalazioneIncarichi segnalazione = new SegnalazioneIncarichi(segnalante, dateformat.parse("07-12-2021"), org,
				"Altro");
		...
		OutputStream out = new FileOutputStream(
				"resource/pdf/test_" + TestIncarichi.class.getSimpleName() + "_" + System.currentTimeMillis() + ".pdf");
